...
Raster / NetCDF climate data
        ↓
Hazard (events + centroids)
        ↓
Exposures (land use, assets, territory)
        ↓
...
CLIMADACOL/
│
├── data/                # Raw and processed climate and spatial data
├── notebooks/           # Jupyter notebooks for exploration and testing
├── src/                 # Core Python scripts (CLIMADA workflow)
├── outputs/             # Generated hazards, exposures, and results
